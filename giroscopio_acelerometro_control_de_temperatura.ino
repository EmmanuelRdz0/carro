...
void encontrar_Salida (int16_t *gyro, int16_t *accel, int32_t *quat, uint32_t *timestamp) {  
  uint8_t SpamDelay = 50;      // demora para escribir en monitor serie de 100 mseg
